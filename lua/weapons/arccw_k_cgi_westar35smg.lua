...
SWEP.IconOverride = "entities/kraken/cgigalactic/westar35smg.png"
...
SWEP.ViewModel = "models/arccw/kraken/cgi_galactic/v_westar35smg.mdl"
...
SWEP.TracerNum = 1
SWEP.TracerCol = Color(250, 142, 0)
SWEP.TracerWidth = 1
...
SWEP.FirstShootSound = "ArcCW_Kraken.SW_WESTAR35SMG"
SWEP.ShootSound = "ArcCW_Kraken.SW_WESTAR35SMG"
...
SWEP.IronSightStruct = {
    Pos = Vector(-4.84, 0, 2.467),
    Ang = Vector(1.325, 0, 0),
     Magnification = 1.5,
