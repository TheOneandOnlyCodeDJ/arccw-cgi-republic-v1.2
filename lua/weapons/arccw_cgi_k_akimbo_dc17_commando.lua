...
SWEP.IconOverride = "entities/arccw/kraken/cgi/17_commando_akimbo.png"
...
SWEP.UseHands = true
SWEP.ViewModel = "models/kraken/cgi/v_cgi_dc17s_akimbo.mdl"
...
SWEP.AttachmentElements = {
    ["dc17"] = {
        WMElements = {
            {
                Model = "models/kraken/cgi/v_cgi_dc17s.mdl",
                Bone = "ValveBiped.Bip01_R_Hand",
                Scale = Vector(1, 1, 1),
                Offset = {
...
WMOverride = "models/kraken/cgi/v_cgi_dc17s.mdl"
