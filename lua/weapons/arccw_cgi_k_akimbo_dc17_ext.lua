...
SWEP.PrintName = "Akimbo DC-17 Extended"
...
SWEP.IconOverride = "entities/arccw/kraken/cgi/17_ext_dual.png"

-- Base
SWEP.DefaultBodygroups = "000000000000"
SWEP.MirrorVMWM = false
SWEP.UseHands = true
SWEP.ViewModel = "models/kraken/cgi/v_cgi_dc17ext_akimbo.mdl"
...
SWEP.AttachmentElements = {
    ["dc17"] = {
        WMElements = {
            {
                Model = "models/kraken/cgi/v_cgi_dc17ext.mdl",
                Bone = "ValveBiped.Bip01_R_Hand",
