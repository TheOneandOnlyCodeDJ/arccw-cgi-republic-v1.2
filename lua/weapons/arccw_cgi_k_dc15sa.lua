...
SWEP.IconOverride = "entities/arccw/kraken/cgi/15sa.png"

-- Base
SWEP.DefaultBodygroups = "000000000000"
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.ViewModel = "models/kraken/cgi/v_cgi_dc15sa.mdl"
...
SWEP.HeatCapacity = 4 -- rounds that can be fired non-stop before the gun jams, playing the "fix" animation
