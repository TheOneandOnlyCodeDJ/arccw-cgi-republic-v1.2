...
SWEP.IconOverride = "entities/kraken/cgigalactic/westar35p.png"

-- Viewmodel & Entity Properties
SWEP.DefaultBodygroups = "000000000000"
SWEP.MirrorVMWM = true
SWEP.UseHands = true
SWEP.ViewModel = "models/arccw/kraken/cgi_galactic/v_westar35p.mdl"
