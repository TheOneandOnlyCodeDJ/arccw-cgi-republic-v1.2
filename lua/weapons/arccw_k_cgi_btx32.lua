...
SWEP.IconOverride = "entities/kraken/cgigalactic/btx32.png"
...
SWEP.ViewModel = "models/arccw/kraken/cgi_galactic/v_btx32.mdl"
...
SWEP.FirstShootSound = "ArcCW_Kraken.SW_BTX32"
SWEP.ShootSound = "ArcCW_Kraken.SW_BTX32"
...
SWEP.Attachments = {     
    ...
    },
    {
        ...
        InstalledEles = {"integrated_muzzle"},
        Bone = "dlt34",
        Offset = {
            vpos = Vector(-0.1, -0.9, 22),
            vang = Angle(90, 0, -90),
        },
        CorrectivePos = Vector(0, 0, 0),
        CorrectiveAng = Angle(0, 0, 0),
