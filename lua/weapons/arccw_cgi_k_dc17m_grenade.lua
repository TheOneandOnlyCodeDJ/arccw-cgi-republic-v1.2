...
SWEP.IconOverride = "materials/entities/grenade_launcher_icon.png"

-- Viewmodel & Entity Properties
SWEP.DefaultBodygroups = "112"
SWEP.UseHands = true
SWEP.MirrorVMWM = true
SWEP.ViewModel = "models/kraken/cgi/v_cgi_dc17m.mdl"
