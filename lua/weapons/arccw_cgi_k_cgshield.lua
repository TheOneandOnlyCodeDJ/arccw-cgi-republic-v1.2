...
SWEP.PrintName = "Shield Shock Batallion"
...
SWEP.IconOverride = "entities/arccw/kraken/cgi/cg_shield.png"
...
SWEP.ViewModel = "models/kraken/cgi/v_cgi_cgshield.mdl"
SWEP.WorldModel = "models/kraken/cgi/v_cgi_cgshield.mdl"
...
SWEP.ShieldProps = {
    {
        Model = "models/kraken/cgi/v_cgi_cgshield.mdl",
        Pos = Vector(0, -15, -12),
        Ang = Angle(0, 0, 180 - 15),
        Resistance = 100
    }
